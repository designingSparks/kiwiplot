...
Kiwiplot also includes a lightweight data explorer application, which can be seen below. The data explorer includes a moveable data cursor, selectable constrained or x-y zoom modes, and zoom stack. All these features are accessible in the toolbar.

<img src="documentation/data_explorer.png" width="400" >
...
## Example Usage
Use of the Kiwiplot widget in a PyQt/PySide application can be seen below. Further examples can be found in the `examples` directory.
...
Example usage of the KiwiWindow class, which is the data explorer application, can be seen below.
